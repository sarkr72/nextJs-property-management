    ...
    <div className="rounded-xl shadow-md relative">
      ...
      <div className="p-4">
        ...
        <div className="flex justify-center gap-4 text-gray-500 mb-4">
          <p>
            <FaBed className="inline mr-2" /> {property.beds} <span className=" lg:inline">beds</span>
          </p>
          <p>
            <FaBath className="inline mr-2" /> {property.baths} <span className="lg:inline">baths</span>
          </p>
          <p>
